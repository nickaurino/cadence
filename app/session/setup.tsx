  ...
  return (
    <View style={styles.container}>
      <Pressable style={styles.settings} hitSlop={14} onPress={() => router.push('/settings')}>
        <SymbolView name="gearshape.fill" size={24} type="monochrome" tintColor="#777" />
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  vibeBtn: { borderRadius: 50, borderWidth: 1.5, borderColor: '#333', paddingVertical: 10, paddingHorizontal: 20 },
  vibeBtnActive: { borderColor: '#1DB954', backgroundColor: '#1DB95422' },
  vibeBtnText: { color: '#aaa', fontSize: 16 },
  vibeBtnTextActive: { color: '#1DB954' },
  startBtn: { backgroundColor: '#1DB954', borderRadius: 50, paddingVertical: 18, alignItems: 'center', marginTop: 48 },
